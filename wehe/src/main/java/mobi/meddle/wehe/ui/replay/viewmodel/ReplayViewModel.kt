...
//
///**
// * ViewModel for managing the Replay functionality in the Wehe app.
// *
// * Handles:
// * - Preparing and executing replay tests
// * - Coordinating UI updates
// * - Managing test state, app status, and results
// * - Handling network and server configuration
// *
// * This ViewModel interacts with a repository (`ReplayRepository`) to perform network
// * operations, communicate with test servers, process results, and update app UI accordingly.
// *
// * @param application The Application context
// * @param repository The repository handling backend operations like networking and test logic
// */
//@HiltViewModel
