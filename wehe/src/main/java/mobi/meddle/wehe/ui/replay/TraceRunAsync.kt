package mobi.meddle.wehe.ui.replay//package mobi.meddle.wehe.ui.replay
//
...
// */
//class TraceRunAsync(private val activity: ReplayActivity) {
...
//    private var serverRepository : ServerRepository = ServerRepository(activity)
//
//    /**
...
//                activity.isReplayOngoing = false
//            }
//        }
//    }
//
...
//                        app!!.status = values[2]
//                    } else {
//                        for (a in activity.selectedApps!!) {
//                            if (values[1] == a.name) {
//                                a.status = values[2]
//                                break
//                            }
...
//                    //update progress bar
//                    val prgBar = activity.progressBar
...
//                        ) { dialog, which ->
//                            val innerActivity = activity
//                            if (exitReplays) {
//                                innerActivity.replayStop()
//                            }
//                            //All tests just finished
//                            if (innerActivity.diffApps.size != 0 ||
//                                innerActivity.inconclusiveApps.size != 0
//                            ) {
//                                innerActivity.displayRerunButtons()
//                            }
//                        }.show()
//                    if (exitReplays) {
//                        Objects.requireNonNull(activity.supportActionBar)?.setTitle(R.string.simple_error)
//                    } else {
//                        Objects.requireNonNull(activity.supportActionBar)?.setTitle(R.string.test_results)
//                    }
//                }
//                else -> {
...
//        for (app in activity.selectedApps!!) {
//            app.status = activity.resources.getString(R.string.pending)
//        }
//
...
//                    activity.getString(R.string.pref_server_key),
//                    Consts.DEFAULT_SERVER
...
//        Config.set("timing", if (activity.runPortTests) "false" else "true")
...
//        if (publicIP == "-1") {
//            updateProgress(
//                "makeDialog", activity.getString(R.string.simple_error),
...
//        }
//        updateProgress(
//            "makeDialog", activity.getString(R.string.replay_finished_title),
//            "", "false"
//        )
...
//        var numTests = if (activity.isTomography) Consts.NUM_TOMOGRAPHY_TESTS else 1
...
//        if (!activity.inconclusiveApps.contains(app)) {
//            activity.addToInconclusiveApps(app!!)
//        }
//        app!!.error = msg
//        updateProgress("updateStatus", app!!.name, activity.getString(R.string.inconclusive))
//    }
//
//    /**
...
//                this.appData = unpickleJSON(app!!.dataFile, activity.activityContext)
//            } else if (channel.equals("random", ignoreCase = true)) {
//                this.appData = unpickleJSON(app!!.randomDataFile, activity.activityContext)
//            } else {
...
//                            + types.size + " " + activity.resources.getString(R.string.create_side_channel))
//                )
...
//                    settings =
//                        activity.getSharedPreferences(ReplayActivity.STATUS, Context.MODE_PRIVATE)
//                    val localSettings = settings
//                    val editor = localSettings?.edit()
//                    editor?.putInt("historyCount", historyCount)
//                    editor?.apply()
...
//                    }
//                    ipThroughProxy = serverRepository.getPublicIP(replayPort)
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.ask4permission))
//                )
...
//                            "1" -> activity.getString(R.string.error_unknown_replay)
//                            "2" -> activity.getString(R.string.error_IP_connected)
//                            "3" -> activity.getString(R.string.error_low_resources)
...
//                 */
//                for (sc in sideChannels) {
//                    sc.sendMobileStats(Config.get("sendMobileStats"), activity.applicationContext)
//                }
//
//                /*
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.receive_server_port_mapping))
//                )
//
//                val serverPortsMaps =
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.create_tcp_client))
//                )
//
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.create_udp_client))
//                )
//
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.run_notf))
//                )
//
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.run_receiver))
//                )
//
...
//                        app!!.time / 2.0,
//                        appData!!.isTCP, numOfTimeSlices[sc.id], activity.runPortTests
//                    ) //throughput logger
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.run_sender))
//                )
//
...
//                    if (activity.runPortTests) Consts.REPLAY_PORT_TIMEOUT else Consts.REPLAY_APP_TIMEOUT
//                )
...
//                updateProgress(
//                    "updateStatus", app!!.name, (iteration.toString() + "/"
//                            + types.size + " " + activity.getString(R.string.send_done))
//                )
//
...
//                if (activity.runPortTests && channel.equals("random", ignoreCase = true)) {
...
//                }
//
//                updateProgress("updateStatus", app!!.name, activity.getString(R.string.waiting))
//
//                // sanity check
...
//                            if (activity.runPortTests) { //"the port 80 issue"
//                                portBlocked = true
...
//                    differentiationNetwork = activity.carrier
//                }
//            }
...
//                    "updateStatus",
//                    app!!.name,
//                    activity.getString(R.string.confirmation_replay)
//                )
...
//                    activity.getString(R.string.tomo_failed)
//                else
...
//
//                var error =
//                    if (activity.runPortTests) activity.getString(R.string.test_blocked_port_text) else activity.getString(
//                        R.string.test_blocked_app_text
//                    )
//                if (!portBlocked) {
//                    error = if (xputOriginal > xputTest) {
//                        if (activity.runPortTests) activity.getString(R.string.test_prioritized_port_text) else activity.getString(
//                            R.string.test_prioritized_app_text
//                        )
//                    } else {
//                        if (activity.runPortTests) activity.getString(R.string.test_throttled_port_text) else activity.getString(
...
//                app!!.error = error
//
//                val current = activity.resources.configuration.locale
...
//            response.put("isPort", activity.runPortTests)
...
//            response.put("carrier", activity.carrier)
//            if (activity.isTomography) {
