...
class TraceRunAsync(private val activity: ReplayActivity) {
                ...
                values[0].equals("makeDialog", ignoreCase = true) -> {
                    ...
                    AlertDialog.Builder(
                        ...
                        .setPositiveButton(
                            ...
                            val innerActivity = activityRef.get()
    ...
    private suspend fun doInBackground(): Void? {
        ...
        val publicIP = getPublicIP("80") //get user's IP address
    ...
    private suspend fun setupServersAndCertificates(server: String, metadataServer: String?): Boolean {
        ...
        for (i in 0 until numTests) {
            if (servers[i] == "") { //check to make sure IP was returned by getServerIP
                ...
                if (wsConns[i] != null && wsConns[i].isOpen) {
                    wsConns[i].close()
                }
                return false
            }
     ...
     */
    private fun getPublicIP(port: String): String {
